...
def upsert_profile(user_id: int, nickname=None, birth_year=None,
                   gender="na", skin_type_code=None,
                   skin_axes_json=None, preferences_json=None,
                   allergies_json=None):
    q = text("""
    INSERT INTO user_profiles
      (user_id, nickname, birth_year, gender,
    ...
    with get_engine().begin() as conn:
        conn.execute(q, {
            "uid": user_id, "nickname": nickname, "byear": birth_year, "gender": gender,
