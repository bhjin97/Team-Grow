...
import { User, Menu, X, Home, MessageSquare, UserCircle, Settings as SettingsIcon, Bell, BellOff, LogOut, Moon, Sun, Globe, Lock, Smartphone, Mail, Shield, Info, ChevronRight, Sparkles, LayoutDashboard } from "lucide-react";
    ...
    background: 'linear-gradient(135deg, #fce7f3 0%, #f3e8ff 50%, #ddd6fe 100%)'
        ...
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-1">
              ...
              <button onClick={() => onNavigate?.('settings')} className="flex items-center space-x-2 px-4 py-2 rounded-lg font-medium transition-colors" style={{
        ...
        duration: 0.5
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-3 border-b border-gray-100">
                  ...
                  <button onClick={() => setPushNotifications(!pushNotifications)} className={`relative w-12 h-6 rounded-full transition-colors ${pushNotifications ? 'bg-pink-500' : 'bg-gray-300'}`}>
                    <motion.div className="absolute top-1 left-1 w-4 h-4 bg-white rounded-full" animate={{
                ...
                <div className="flex items-center justify-between py-3 border-b border-gray-100">
                  ...
                  <button onClick={() => setEmailNotifications(!emailNotifications)} className={`relative w-12 h-6 rounded-full transition-colors ${emailNotifications ? 'bg-pink-500' : 'bg-gray-300'}`}>
                    <motion.div className="absolute top-1 left-1 w-4 h-4 bg-white rounded-full" animate={{
                ...
                <div className="flex items-center justify-between py-3 border-b border-gray-100">
                  ...
                  <button onClick={() => setProductUpdates(!productUpdates)} className={`relative w-12 h-6 rounded-full transition-colors ${productUpdates ? 'bg-pink-500' : 'bg-gray-300'}`}>
                    <motion.div className="absolute top-1 left-1 w-4 h-4 bg-white rounded-full" animate={{
                ...
                <div className="flex items-center justify-between py-3">
                  ...
                  <button onClick={() => setWeeklyReport(!weeklyReport)} className={`relative w-12 h-6 rounded-full transition-colors ${weeklyReport ? 'bg-pink-500' : 'bg-gray-300'}`}>
                    <motion.div className="absolute top-1 left-1 w-4 h-4 bg-white rounded-full" animate={{
                    x: weeklyReport ? 24 : 0
                  }} transition={{
                    type: "spring",
            ...
            <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-3 border-b border-gray-100">
                  ...
                  <button onClick={() => setDarkMode(!darkMode)} className={`relative w-12 h-6 rounded-full transition-colors ${darkMode ? 'bg-indigo-500' : 'bg-gray-300'}`}>
                    <motion.div className="absolute top-1 left-1 w-4 h-4 bg-white rounded-full" animate={{
                    x: darkMode ? 24 : 0
                  }} transition={{
                    type: "spring",
                ...
                <div className="flex items-center justify-between py-3">
                  ...
                  <select value={language} onChange={e => setLanguage(e.target.value)} className="px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-pink-300">
              ...
              <div className="space-y-3">
                <button className="w-full flex items-center justify-between py-3 px-4 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm sm:text-base font-medium text-gray-800">비밀번호 변경</span>
                  </div>
                ...
                <button className="w-full flex items-center justify-between py-3 px-4 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm sm:text-base font-medium text-gray-800">개인정보 처리방침</span>
                  </div>
                  <ChevronRight className="w-5 h-5 text-gray-400" />
                </button>
                ...
                <button className="w-full flex items-center justify-between py-3 px-4 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="flex items-center space-x-3">
                    <Info className="w-5 h-5 text-gray-500" />
                    <span className="text-sm sm:text-base font-medium text-gray-800">서비스 이용약관</span>
                  </div>
                  <ChevronRight className="w-5 h-5 text-gray-400" />
                </button>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6">
              ...
              <div className="space-y-3">
                <motion.button onClick={handleLogout} className="w-full flex items-center justify-center space-x-3 py-3 px-4 rounded-lg bg-red-50 text-red-600 hover:bg-red-100 transition-colors font-medium" whileHover={{
                scale: 1.02
              }} whileTap={{
                scale: 0.98
              }}>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-lg border-t border-pink-100 z-50">
        <div className="flex items-center justify-around px-4 py-3">
          ...
          <button onClick={() => onNavigate?.('settings')} className="flex flex-col items-center space-y-1 text-pink-600">
