...
export const DashboardHeader = ({ userName = 'Sarah', onNavigate }: DashboardHeaderProps) => {
        ...
        {mobileMenuOpen && (
          ...
          >
            <button
              ...
              className="w-full flex items-center space-x-2 px-4 py-2 rounded-lg text-white font-semibold"
              style={{ background: 'linear-gradient(135deg, #f5c6d9 0%, #e8b4d4 100%)' }}
            >
              <LayoutDashboard className="w-5 h-5" /> <span>대시보드</span>
            </button>
