...
- **결과:** 제품 특징 중심 질문은 벡터 검색 결과를 상품 정보와 연결하고, 특징과 명시 조건이 함께 있는 질문은 벡터 후보를 RDB에서 필터링하도록 구성했습니다. 모든 주요 조건이 포함된 질문은 RDB에서 후보를 먼저 축소한 뒤 벡터 유사도로 재정렬하여 의미 검색과 구조화 조건 검색을 결합했습니다.
